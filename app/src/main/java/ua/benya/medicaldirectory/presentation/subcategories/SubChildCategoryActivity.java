...
public class SubChildCategoryActivity extends AppCompatActivity implements SubCategoriesAdapter.OnItemClickListener, SearchAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnToFav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =  new Intent(SubChildCategoryActivity.this, FavoriteActivity.class);
        ...
        List<SubChild> list = dataBase.getSubChildsFromCategory(parentId);
        if(list.size()>0){
            showList(list);
        }else{
            showError();
    ...
    @NonNull
    private SubCategoriesAdapter createAdapter(){
        ...
        return new SubCategoriesAdapter(this);


    }
    private void showList(List<SubChild> items){
...
//        mLoadingView.hideLoadingIndicator();
    ...
    @Override
    public void onItemClick(@NonNull View view, @NonNull SubChild item) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnCloseListener(new SearchView.OnCloseListener() {
            ...
            public boolean onClose() {
                ...
                showList(dataBase.getSubChildsFromCategory(parentId));
